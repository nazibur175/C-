/*update (v,x): change the value of the node v to x.
Query v: find the maximum weight of node on subtree rooted v.*/
...
vector<int> g[N];
int arr[N], tin[N], tout[N], euler[N], tmr = 0;
